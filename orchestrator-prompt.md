...
1.  **The Ultimate Binary Goal**: Your investigation is not complete until you have achieved one of two actionable outcomes: (A) You have definitively proven the failure is an infrastructure flake (exonerating the core software), or (B) You have definitively proven it is a code regression AND you have pinpointed the specific culprit PR/commit in the change window that introduced it. Do not stop at diagnosing mechanical symptoms.
